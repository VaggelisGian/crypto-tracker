...
public class App extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1017, 500));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(pathLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 803, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(94, 94, 94)
                    .addComponent(pathLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 812, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            final Document document = Jsoup.connect(url).timeout(20000).get();
            ...
            for (Element row : document.select("table.sort.table.mb-0.text-sm.text-lg-normal.table-scrollable tr"))
            {
                ...
                else
                {
                    ...
                    String firstword = name.substring(0, index); 
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        try {
            ...
            pathLabel1.setText("Successfully wrote to the file.");
            pathLabel.setText("Path :"+path.toAbsolutePath());
        } catch (IOException e) {
        ...
        try {
            ...
            for (Element row : document.select("table.sort.table.mb-0.text-sm.text-lg-normal.table-scrollable tr"))
            {
                ...
                else
                {
                    ...
                    String name = row.select("td:nth-of-type(3)").text();
                    String arr[] = name.split(" ", 2);              //gia ta prwta 10
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        final int col = 0; // final int col = jTable1.columnAtPoint(evt.getPoint());
        if (row >= 0 && col >= 0) 
        {
            System.out.println("App.jTable1MouseClicked()" + "row: "+row +" col: "+col);
            String tempurl= "https://www.coingecko.com/en/coins/";
            System.out.println("App.jTable1MouseClicked()" + "row: "+row +" col: "+col +" "+getdata(row, col).toLowerCase());
            String replacetemp = getdata(row, col).toLowerCase();
            if(replacetemp.contains("(") && replacetemp.contains (")"))
            {
                replacetemp = replacetemp.replaceFirst("\\(.+?\\)", "");
                replacetemp = replacetemp.replaceAll("\\s", "");
                
            }
            else
            {
                replacetemp = getdata(row, col).toLowerCase().replace(' ', '-');
            }
            
            String url = tempurl + replacetemp;  //Add Characters to a String 
            String osName = System.getProperty("os.name");
                    try {
                            if (osName.startsWith("Windows"))
                                    Runtime.getRuntime().exec(
